...
declare class NewAxios {
    ...
    errorHandling(): void;
    getError(data: any, prompt: boolean): void;
    clearAntiShake(tag: string): void;
    parade(obj: any): void;
    Request(obj: any): Promise<unknown>;
    GetByUrl(url: string, params: any, baseURL: string, prompt: boolean, timeout: number): Promise<unknown>;
    PostByUrl(url: string, data: any, baseURL: string, prompt: boolean, timeout: number): Promise<unknown>;
    GetByBody(url: string, data: any, baseURL: string, prompt: boolean, timeout: number): Promise<unknown>;
    PostByBody(url: string, data: any, baseURL: string, prompt: boolean, timeout: number, isAntiShake: boolean | string): Promise<unknown>;
    PostFormDate(url: string, data: any, baseURL: string, prompt: boolean, timeout: number): Promise<unknown>;
    PostExport(url: string, data: any, baseURL: string, prompt: boolean, timeout: number): Promise<any>;
}
