...
import { trainData, testData, PlotlyRef } from './variable'
...
export const updateScatterWithLines = (dateTrace, k, b, N, traceIndex) => {
  ...
  PlotlyRef.value.PlotlyRestyle('dataSpaceWith4Lines', update, traceIndex)
}
...
export const training = async () => {
  ...
  // model.predict(tensor2d([[1], [100], [10000]]))
}

export default { trainTensors, testTensors, model, optimizer, updateScatterWithLines, training }
